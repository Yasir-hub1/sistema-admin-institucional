...
const RegistroEstudiante = () => {
  ...
  const { registrar, isAuthenticated, user, loading: authLoading } = useAuth()
  ...
  // Si está autenticado, mostrar redirección
  if (isAuthenticated && user?.rol === 'ESTUDIANTE') {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (result.success) {
        // El AuthContext ya maneja el token y el estado
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="pt-4">
              ...
              >
                {isSubmitting || authLoading ? 'Registrando...' : 'Crear Cuenta'}
              </Button>
            </div>
          </form>
